...
This document captures the current status and process for Phase 0 of the PromtLint project. It is intended to record what has been shipped in Phase 0, which contracts and artifacts are defined, and what remains to be implemented in later phases.
...
- `packages/rules`
- `packages/reporter-human`
- `packages/reporter-json`
- `packages/test-utils`
- `packages/types`
...
- Test coverage currently focuses on contract validation and manifest stability.
